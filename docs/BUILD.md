...
3. **Зависимости системы**:
   ...
   - Linux: `libwebkit2gtk-4.1-dev` (Ubuntu 24.04) или `libwebkit2gtk-4.0-dev` (Ubuntu ≤22.04), `build-essential`, `curl`, `wget`, `pkg-config`, `libssl-dev`, `libgtk-3-dev`, `libglib2.0-dev`, `libayatana-appindicator3-dev`, `librsvg2-dev`, `patchelf`
